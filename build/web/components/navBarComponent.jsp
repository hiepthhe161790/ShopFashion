...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="home">Pet House</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                <c:if test="${sessionScope.acc.isAdmin == 1}">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="managerAccount">Dashboard Admin</a>
                    </li>
<!--                    <li class="nav-item">
                ...
                <c:if test="${sessionScope.acc.isSell == 1}">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="manager">Dashboard Seller</a>
                    </li>
<!--                     <li class="nav-item">
                ...
                <c:if test="${sessionScope.acc != null}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="order-history">Order</a>
                    </li>
                     <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="updateProfile">Profile</a>
                    </li>
                </c:if>
